...
export class TransactionBuilder {
    ...
    */
    construct(collateral_utxos, collateral_change_address, native_uplc, force_phase_2_validation) {
        const ptr = this.__destroy_into_raw();
        let ptr0 = 0;
        ...
        const ret = wasm.transactionbuilder_construct(ptr, ptr0, ptr1, isLikeNone(native_uplc) ? 0xFFFFFF : native_uplc ? 1 : 0, isLikeNone(force_phase_2_validation) ? 0xFFFFFF : force_phase_2_validation ? 1 : 0);
